...
# Directory Setup
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))   # ZaberScan/results/analyzed
ANALYZED_DIR = SCRIPT_DIR
RESULTS_DIR = os.path.dirname(ANALYZED_DIR)               # ZaberScan/results
PROJECT_DIR = os.path.dirname(RESULTS_DIR)               # ZaberScan
